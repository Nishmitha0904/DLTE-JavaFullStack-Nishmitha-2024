 ...
 * 
 */
@WebServiceClient(name = "UserSoapService", targetNamespace = "http://web.soap.service/", wsdlLocation = "http://localhost:1234/transact?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:1234/transact?wsdl");
