 ...
 * 
 */
@WebServiceClient(name = "EmployeeSoapService", targetNamespace = "http://service.soap/", wsdlLocation = "http://localhost:1234/employee?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESOAPSERVICE_QNAME = new QName("http://service.soap/", "EmployeeSoapService");
    ...
    public EmployeeSoap getEmployeeSoapPort() {
        return super.getPort(new QName("http://service.soap/", "EmployeeSoapPort"), EmployeeSoap.class);
    }
    ...
    public EmployeeSoap getEmployeeSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.soap/", "EmployeeSoapPort"), EmployeeSoap.class, features);
    }
