 ...
 * 
 */
@WebServiceClient(name = "EmployeePortService", targetNamespace = "http://employee.services", wsdlLocation = "http://localhost:8082/employee/employee.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8082/employee/employee.wsdl");
